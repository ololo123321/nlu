...
def load_examples(
    ...
    :param tokens_pattern: регулярка для токенизации
    ...
    :param lang:
    :param ignore_bad_examples: если True, то игнорировать пример, на котором возникла ошибка, False - вызвать ошбку
    :return:
    """
